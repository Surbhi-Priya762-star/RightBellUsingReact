    ...
    <div>
        ...
        <Row className="justify-content-md-center mt-5">
            ...
            <Col xs={3}>
              <Row>
              <Col>
                  <p onClick={forgotPassword} style={{color: '#0B5ED7', cursor:"pointer"}}>Forgot password ?</p>
                </Col>
                <Col>
                  <Button onClick={handleSubmit} disabled={!email || !pass} style={{width: '100%'}} variant="primary">Login</Button>
                </Col>
            ...
            <Col className="mt-5" xs={3}>
               ...
               <Row className="justify-content-md-around">
                 <Col xs={12}>
                   <p onClick={() => props.history.push('/ServiceUser')} style={{color: '#0B5ED7', cursor:"pointer"}}>Service user</p>
                 </Col>
                 <Col>
                   <p onClick={() => props.history.push('/ServiceProvider')} style={{color: '#0B5ED7', cursor:"pointer"}}>Service provider</p>
                 </Col>
               </Row>
            </Col>
        </Row>
